...
use std::path::Path;
use std::fs;
use super::models::{FileInfo, FilesResponse, FileType, IMAGE_EXTENSIONS, VIDEO_EXTENSIONS, GIF_EXTENSION};

/// GET /api/file/info?folder=<path>
/// 获取指定文件夹的所有媒体文件信息
pub async fn get_file_info(query: web::Query<std::collections::HashMap<String, String>>) -> Result<HttpResponse> {
